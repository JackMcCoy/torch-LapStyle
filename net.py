...
class StyleAttention(nn.Module):
    def __init__(self, chan, chan_out=None, s_d = 64, batch_size=4, kernel_size=1, padding=0, stride=1, key_dim=64, value_dim=64, heads=8,
        ...
        self.to_q = AdaConv(chan, 1, s_d=s_d, batch_size=batch_size, c_out=key_dim * heads, kernel_size=3)
        self.to_kv = AdaConv(chan*2, 1, s_d=s_d, batch_size=batch_size, c_out=key_dim * heads * 2, kernel_size=3)
