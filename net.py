...
from modules import ETF,GaussianNoise, ScaleNorm, BlurPool, ConvMixer, ResBlock, ConvBlock, WavePool, WaveUnpool, SpectralResBlock, RiemannNoise, PixelShuffleUp, Upblock, Downblock, adaconvs, StyleEncoderBlock, FusedConvNoiseBias
...
class ThumbAdaConv(nn.Module):
    def __init__(self, style_contrastive_loss=False,content_contrastive_loss=False,batch_size=8, s_d = 64):
        ...
        self.content_injection_layer = ['r4_1',None,'r3_1',None,'r2_1',None]
...
def calc_losses(stylized: torch.Tensor,
    ...
    if remd_loss:
        style_remd = style_remd_loss(stylized_feats['r4_1'], sF['r4_1']) + \
                     ...
                     style_remd_loss(stylized_feats['r2_1'], sF['r2_1']) + \
                     style_remd_loss(stylized_feats['r1_1'], sF['r1_1'])
