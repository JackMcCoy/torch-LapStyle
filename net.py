    ...
    def __init__(self, style_contrastive_loss=False,content_contrastive_loss=False,batch_size=8, s_d = 64):
        ...
        self.learnable = nn.ModuleList([
            nn.Sequential(
                ...
                GaussianNoise(),
                FusedLeakyReLU(256),
                BlurPool(256, pad_type='reflect', filt_size=4, stride=2, pad_off=0)
            ),
            nn.Sequential(
                nn.ReflectionPad2d((1, 1, 1, 1)),
                ...
                #nn.GroupNorm(32, 128),
                nn.LeakyReLU(),
                BlurPool(128, pad_type='reflect', filt_size=4, stride=2, pad_off=0)
            ),
            nn.Sequential(
                nn.ReflectionPad2d((1, 1, 1, 1)),
            ...
            nn.Sequential(
                ...
                #nn.GroupNorm(32, 64),
                nn.LeakyReLU(),
                BlurPool(64, pad_type='reflect', filt_size=4, stride=2, pad_off=0)
            ),
            nn.Sequential(
                nn.ReflectionPad2d((1, 1, 1, 1)),
