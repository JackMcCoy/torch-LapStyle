...
def adaconv_thumb_train():
    ...
    for n in tqdm(range(args.max_iter), position=0):
        ...
        loss = loss_patch_disc * args.gan_loss2 + loss_c * args.content_weight + args.style_weight * loss_s + content_relt * args.content_relt + style_remd * args.style_remd + patch_loss * args.patch_loss + \
