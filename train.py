...
def revision_train():
    ...
    with autocast(enabled=ac_enabled):
        ...
        dec_ = torch.jit.trace(net.DecoderAdaConv(batch_size=args.batch_size),({'r4_1': torch.rand(args.batch_size,512,32,32),
                                                                                'r3_1': torch.rand(args.batch_size,256,64,64),
                                                                                'r2_1': torch.rand(args.batch_size,128,128,128),
                                                                                'r1_1': torch.rand(args.batch_size,64,256,256),},
