...
class LapRev(nn.Module):
    def __init__(self, max_res, working_res, batch_size, s_d):
        ...
        self.layers = module_list_to_momentum_net(nn.ModuleList([Sequential_Worker(params[i[0]],self.max_res,256, batch_size, s_d) for i in self.num_layers]),target_device='cuda:0')
