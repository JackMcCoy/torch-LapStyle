...
class LapRev(nn.Module):
    def __init__(self, max_res, working_res, batch_size, s_d, momentumnet_beta):
        ...
        self.momentumnet = revlib.ReversibleSequential(*momentum_modules,split_dim=0,coupling_forward=coupling_forward,coupling_inverse=coupling_inverse,memory_mode = revlib.MemoryModes.no_savings,target_device='cuda')
        '''
